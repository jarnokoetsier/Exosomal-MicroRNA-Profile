...
miRNA_set <- read.table("E:/RTTproject/ExosomeAnalysis/Time Analysis/DownExpr.txt", col.names = "miRNA")
...
miRNA_set <- read.table("E:/RTTproject/ExosomeAnalysis/Time Analysis/UpExpr.txt", col.names = "miRNA")
...
miRNA_set <- read.table("E:/RTTproject/ExosomeAnalysis/Time Analysis/ConstantExpr.txt", col.names = "miRNA")
...
miRNA_set <- read.table("E:/RTTproject/ExosomeAnalysis/RTTvsIC/RTTvsIC.txt", col.names = "miRNA")
